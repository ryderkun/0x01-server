...
%% Generated by gpb_compile version 3.18.4 on {{2015,6,10},{1,19,33}}
-module(protocol).
...
e_msg_ProtocolUnit(#'ProtocolUnit'{id = F1, pos = F2,
				   towards = F3, status = F4, score = F5,
				   name = F6, color = F7, update_at = F8},
		   Bin) ->
    ...
    B5 = e_type_float(F5, <<B4/binary, 45>>),
...
dfp_read_field_def_ProtocolUnit(<<45, Rest/binary>>, Z1,
				Z2, F1, F2, F3, F4, F5, F6, F7, F8) ->
    d_field_ProtocolUnit_score(Rest, Z1, Z2, F1, F2, F3, F4,
			       F5, F6, F7, F8);
dfp_read_field_def_ProtocolUnit(<<50, Rest/binary>>, Z1,
				Z2, F1, F2, F3, F4, F5, F6, F7, F8) ->
...
dfp_read_field_def_ProtocolUnit(<<56, Rest/binary>>, Z1,
    ...
    d_field_ProtocolUnit_color(Rest, Z1, Z2, F1, F2, F3, F4,
			       F5, F6, F7, F8);
dfp_read_field_def_ProtocolUnit(<<64, Rest/binary>>, Z1,
				Z2, F1, F2, F3, F4, F5, F6, F7, F8) ->
    d_field_ProtocolUnit_update_at(Rest, Z1, Z2, F1, F2, F3,
				   F4, F5, F6, F7, F8);
dfp_read_field_def_ProtocolUnit(<<>>, 0, 0, F1, F2, F3,
				F4, F5, F6, F7, F8) ->
    #'ProtocolUnit'{id = F1, pos = F2, towards = F3,
		    status = F4, score = F5, name = F6, color = F7,
		    update_at = F8};
...
dg_read_field_def_ProtocolUnit(<<0:1, X:7,
    ...
    case Key of
	  ...
	  d_field_ProtocolUnit_status(Rest, 0, 0, F1, F2, F3, F4,
				      F5, F6, F7, F8);
      45 ->
	  d_field_ProtocolUnit_score(Rest, 0, 0, F1, F2, F3, F4,
				     F5, F6, F7, F8);
      50 ->
	  ...
	  d_field_ProtocolUnit_color(Rest, 0, 0, F1, F2, F3, F4,
				     F5, F6, F7, F8);
      64 ->
	  d_field_ProtocolUnit_update_at(Rest, 0, 0, F1, F2, F3,
					 F4, F5, F6, F7, F8);
      _ ->
	  case Key band 7 of
	    0 ->
...
d_field_ProtocolUnit_score(<<Value:32/little-float,
			     Rest/binary>>,
			   Z1, Z2, F1, F2, F3, F4, _, F6, F7, F8) ->
    dfp_read_field_def_ProtocolUnit(Rest, Z1, Z2, F1, F2,
				    F3, F4, Value, F6, F7, F8).
...
d_field_ProtocolUnit_update_at(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F1, F2, F3, F4, F5, F6, F7, F8)
    when N < 57 ->
    d_field_ProtocolUnit_update_at(Rest, N + 7,
				   X bsl N + Acc, F1, F2, F3, F4, F5, F6, F7,
				   F8);
d_field_ProtocolUnit_update_at(<<0:1, X:7,
				 Rest/binary>>,
...
dg_read_field_def_ProtocolUnitUpdate(<<0:1, X:7,
    ...
    Key = X bsl N + Acc,
    case Key of
      18 -> d_field_ProtocolUnitUpdate_units(Rest, 0, 0, F1);
      _ ->
	  case Key band 7 of
...
merge_msg_ProtocolUnit(#'ProtocolUnit'{id = PFid,
				       ...
				       status = PFstatus, score = PFscore,
				       name = PFname, color = PFcolor,
				       update_at = PFupdate_at},
		       #'ProtocolUnit'{id = NFid, pos = NFpos,
				       towards = NFtowards, status = NFstatus,
				       score = NFscore, name = NFname,
				       color = NFcolor,
				       update_at = NFupdate_at}) ->
    #'ProtocolUnit'{id =
...
v_msg_ProtocolUnit(#'ProtocolUnit'{id = F1, pos = F2,
    ...
    v_type_int64(F8, [update_at | Path]),
    ok;
