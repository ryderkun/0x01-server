...
%% Generated by gpb_compile version 3.18.4 on {{2015,6,11},{22,20,1}}
-module(protocol).
...
encode_msg(Msg, Opts) ->
    ...
    case Msg of
	  ...
	  'e_msg_ProtocolUnitMove.UnitMoving'(Msg);
      #'ProtocolUnitMove'{} -> e_msg_ProtocolUnitMove(Msg);
      #'ProtocolUnitEject'{} -> e_msg_ProtocolUnitEject(Msg);
      ...
      #'ProtocolUnitSplit'{} -> e_msg_ProtocolUnitSplit(Msg);
...
'e_msg_ProtocolUnitMove.UnitMoving'(#'ProtocolUnitMove.UnitMoving'{id
								       = F1,
								   pos = F2,
								   direction =
								       F3},
				    Bin) ->
    B1 = e_type_string(F1, <<Bin/binary, 10>>),
    B2 = 'e_mfield_ProtocolUnitMove.UnitMoving_pos'(F2,
						    <<B1/binary, 18>>),
    'e_mfield_ProtocolUnitMove.UnitMoving_direction'(F3,
						     <<B2/binary, 26>>).
...
e_msg_ProtocolUnitMove(#'ProtocolUnitMove'{update_at =
					       F1,
					   units = F2},
		       Bin) ->
    B1 = e_type_int64(F1, <<Bin/binary, 8>>),
    if F2 == [] -> B1;
       true -> e_field_ProtocolUnitMove_units(F2, B1)
    end.

e_msg_ProtocolUnitEject(_Msg) -> <<>>.
...
e_msg_ProtocolConfig(#'ProtocolConfig'{sync_interval =
					   F1},
		     Bin) ->
    e_type_float(F1, <<Bin/binary, 13>>).

e_msg_ProtocolUnitSplit(_Msg) -> <<>>.
...
'e_mfield_ProtocolUnitMove.UnitMoving_pos'(Msg, Bin) ->
    Bin2 = <<Bin/binary, 10>>,
    e_msg_ProtocolVector2(Msg, Bin2).

'e_mfield_ProtocolUnitMove.UnitMoving_direction'(Msg,
						 Bin) ->
    Bin2 = <<Bin/binary, 10>>,
    e_msg_ProtocolVector2(Msg, Bin2).

e_mfield_ProtocolUnitMove_units(Msg, Bin) ->
    SubBin = 'e_msg_ProtocolUnitMove.UnitMoving'(Msg, <<>>),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_ProtocolUnitMove_units([Elem | Rest], Bin) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_ProtocolUnitMove_units(Elem, Bin2),
    e_field_ProtocolUnitMove_units(Rest, Bin3);
e_field_ProtocolUnitMove_units([], Bin) -> Bin.
...
decode_msg(Bin, MsgName) when is_binary(Bin) ->
    case MsgName of
      ...
      'ProtocolUnitMove.UnitMoving' ->
	  'd_msg_ProtocolUnitMove.UnitMoving'(Bin);
      'ProtocolUnitMove' -> d_msg_ProtocolUnitMove(Bin);
      'ProtocolUnitEject' -> d_msg_ProtocolUnitEject(Bin);
      ...
      'ProtocolUnitSplit' -> d_msg_ProtocolUnitSplit(Bin);
...
'd_msg_ProtocolUnitMove.UnitMoving'(Bin) ->
    'dfp_read_field_def_ProtocolUnitMove.UnitMoving'(Bin, 0,
						     0, undefined, undefined,
						     undefined).

'dfp_read_field_def_ProtocolUnitMove.UnitMoving'(<<10,
						   Rest/binary>>,
						 Z1, Z2, F1, F2, F3) ->
    'd_field_ProtocolUnitMove.UnitMoving_id'(Rest, Z1, Z2,
					     F1, F2, F3);
'dfp_read_field_def_ProtocolUnitMove.UnitMoving'(<<18,
						   Rest/binary>>,
						 Z1, Z2, F1, F2, F3) ->
    'd_field_ProtocolUnitMove.UnitMoving_pos'(Rest, Z1, Z2,
					      F1, F2, F3);
'dfp_read_field_def_ProtocolUnitMove.UnitMoving'(<<26,
						   Rest/binary>>,
						 Z1, Z2, F1, F2, F3) ->
    'd_field_ProtocolUnitMove.UnitMoving_direction'(Rest,
						    Z1, Z2, F1, F2, F3);
'dfp_read_field_def_ProtocolUnitMove.UnitMoving'(<<>>,
						 0, 0, F1, F2, F3) ->
    #'ProtocolUnitMove.UnitMoving'{id = F1, pos = F2,
				   direction = F3};
'dfp_read_field_def_ProtocolUnitMove.UnitMoving'(Other,
						 Z1, Z2, F1, F2, F3) ->
    'dg_read_field_def_ProtocolUnitMove.UnitMoving'(Other,
						    Z1, Z2, F1, F2, F3).

'dg_read_field_def_ProtocolUnitMove.UnitMoving'(<<1:1,
						  X:7, Rest/binary>>,
						N, Acc, F1, F2, F3)
    when N < 32 - 7 ->
    'dg_read_field_def_ProtocolUnitMove.UnitMoving'(Rest,
						    N + 7, X bsl N + Acc, F1,
						    F2, F3);
'dg_read_field_def_ProtocolUnitMove.UnitMoving'(<<0:1,
						  X:7, Rest/binary>>,
						N, Acc, F1, F2, F3) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  'd_field_ProtocolUnitMove.UnitMoving_id'(Rest, 0, 0, F1,
						   F2, F3);
      18 ->
	  'd_field_ProtocolUnitMove.UnitMoving_pos'(Rest, 0, 0,
						    F1, F2, F3);
      26 ->
	  'd_field_ProtocolUnitMove.UnitMoving_direction'(Rest, 0,
							  0, F1, F2, F3);
      _ ->
	  case Key band 7 of
	    0 ->
		'skip_varint_ProtocolUnitMove.UnitMoving'(Rest, 0, 0,
							  F1, F2, F3);
	    1 ->
		'skip_64_ProtocolUnitMove.UnitMoving'(Rest, 0, 0, F1,
						      F2, F3);
	    2 ->
		'skip_length_delimited_ProtocolUnitMove.UnitMoving'(Rest,
								    0, 0, F1,
								    F2, F3);
	    5 ->
		'skip_32_ProtocolUnitMove.UnitMoving'(Rest, 0, 0, F1,
						      F2, F3)
	  end
    end;
'dg_read_field_def_ProtocolUnitMove.UnitMoving'(<<>>, 0,
						0, F1, F2, F3) ->
    #'ProtocolUnitMove.UnitMoving'{id = F1, pos = F2,
				   direction = F3}.

'd_field_ProtocolUnitMove.UnitMoving_id'(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F1, F2, F3)
    when N < 57 ->
    'd_field_ProtocolUnitMove.UnitMoving_id'(Rest, N + 7,
					     X bsl N + Acc, F1, F2, F3);
'd_field_ProtocolUnitMove.UnitMoving_id'(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, _, F2, F3) ->
    Len = X bsl N + Acc,
    <<Bytes:Len/binary, Rest2/binary>> = Rest,
    NewFValue = binary:copy(Bytes),
    'dfp_read_field_def_ProtocolUnitMove.UnitMoving'(Rest2,
						     0, 0, NewFValue, F2, F3).


'd_field_ProtocolUnitMove.UnitMoving_pos'(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, F1, F2, F3)
    when N < 57 ->
    'd_field_ProtocolUnitMove.UnitMoving_pos'(Rest, N + 7,
					      X bsl N + Acc, F1, F2, F3);
'd_field_ProtocolUnitMove.UnitMoving_pos'(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, F1, F2, F3) ->
    Len = X bsl N + Acc,
    <<Bs:Len/binary, Rest2/binary>> = Rest,
...
'd_field_ProtocolUnitMove.UnitMoving_direction'(<<1:1,
						  X:7, Rest/binary>>,
						N, Acc, F1, F2, F3)
    when N < 57 ->
    'd_field_ProtocolUnitMove.UnitMoving_direction'(Rest,
						    N + 7, X bsl N + Acc, F1,
						    F2, F3);
'd_field_ProtocolUnitMove.UnitMoving_direction'(<<0:1,
						  X:7, Rest/binary>>,
						N, Acc, F1, F2, F3) ->
    Len = X bsl N + Acc,
    <<Bs:Len/binary, Rest2/binary>> = Rest,
...
'skip_varint_ProtocolUnitMove.UnitMoving'(<<1:1, _:7,
					    Rest/binary>>,
					  Z1, Z2, F1, F2, F3) ->
    'skip_varint_ProtocolUnitMove.UnitMoving'(Rest, Z1, Z2,
					      F1, F2, F3);
'skip_varint_ProtocolUnitMove.UnitMoving'(<<0:1, _:7,
					    Rest/binary>>,
					  Z1, Z2, F1, F2, F3) ->
    'dfp_read_field_def_ProtocolUnitMove.UnitMoving'(Rest,
						     Z1, Z2, F1, F2, F3).


'skip_length_delimited_ProtocolUnitMove.UnitMoving'(<<1:1,
						      X:7, Rest/binary>>,
						    N, Acc, F1, F2, F3)
    when N < 57 ->
    'skip_length_delimited_ProtocolUnitMove.UnitMoving'(Rest,
							N + 7, X bsl N + Acc,
							F1, F2, F3);
'skip_length_delimited_ProtocolUnitMove.UnitMoving'(<<0:1,
						      X:7, Rest/binary>>,
						    N, Acc, F1, F2, F3) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
...
'skip_32_ProtocolUnitMove.UnitMoving'(<<_:32,
					Rest/binary>>,
				      Z1, Z2, F1, F2, F3) ->
    'dfp_read_field_def_ProtocolUnitMove.UnitMoving'(Rest,
						     Z1, Z2, F1, F2, F3).
...
'skip_64_ProtocolUnitMove.UnitMoving'(<<_:64,
					Rest/binary>>,
				      Z1, Z2, F1, F2, F3) ->
    'dfp_read_field_def_ProtocolUnitMove.UnitMoving'(Rest,
						     Z1, Z2, F1, F2, F3).
...
dfp_read_field_def_ProtocolUnitMove(<<8, Rest/binary>>,
				    Z1, Z2, F1, F2) ->
    d_field_ProtocolUnitMove_update_at(Rest, Z1, Z2, F1,
				       F2);
dfp_read_field_def_ProtocolUnitMove(<<18, Rest/binary>>,
				    Z1, Z2, F1, F2) ->
    d_field_ProtocolUnitMove_units(Rest, Z1, Z2, F1, F2);
dfp_read_field_def_ProtocolUnitMove(<<>>, 0, 0, F1,
				    F2) ->
    #'ProtocolUnitMove'{update_at = F1,
			units = lists:reverse(F2)};
dfp_read_field_def_ProtocolUnitMove(Other, Z1, Z2, F1,
				    F2) ->
...
dg_read_field_def_ProtocolUnitMove(<<0:1, X:7,
    ...
    case Key of
      8 ->
	  d_field_ProtocolUnitMove_update_at(Rest, 0, 0, F1, F2);
      18 ->
	  d_field_ProtocolUnitMove_units(Rest, 0, 0, F1, F2);
      _ ->
	  case Key band 7 of
	    0 -> skip_varint_ProtocolUnitMove(Rest, 0, 0, F1, F2);
	    1 -> skip_64_ProtocolUnitMove(Rest, 0, 0, F1, F2);
	    2 ->
		skip_length_delimited_ProtocolUnitMove(Rest, 0, 0, F1,
						       F2);
	    5 -> skip_32_ProtocolUnitMove(Rest, 0, 0, F1, F2)
	  end
    end;
...
d_field_ProtocolUnitMove_update_at(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F1, F2)
    when N < 57 ->
    d_field_ProtocolUnitMove_update_at(Rest, N + 7,
				       X bsl N + Acc, F1, F2);
d_field_ProtocolUnitMove_update_at(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, _, F2) ->
    <<NewFValue:64/signed-native>> = <<(X bsl N +
					  Acc):64/unsigned-native>>,
    dfp_read_field_def_ProtocolUnitMove(Rest, 0, 0,
					NewFValue, F2).


d_field_ProtocolUnitMove_units(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F1, F2)
    when N < 57 ->
    d_field_ProtocolUnitMove_units(Rest, N + 7,
				   X bsl N + Acc, F1, F2);
d_field_ProtocolUnitMove_units(<<0:1, X:7,
				 Rest/binary>>,
			       N, Acc, F1, F2) ->
    Len = X bsl N + Acc,
    <<Bs:Len/binary, Rest2/binary>> = Rest,
...
skip_varint_ProtocolUnitMove(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, F1, F2) ->
    skip_varint_ProtocolUnitMove(Rest, Z1, Z2, F1, F2);
...
d_msg_ProtocolUnitEject(Bin) ->
    dfp_read_field_def_ProtocolUnitEject(Bin, 0, 0).

dfp_read_field_def_ProtocolUnitEject(<<>>, 0, 0) ->
    #'ProtocolUnitEject'{};
dfp_read_field_def_ProtocolUnitEject(Other, Z1, Z2) ->
    dg_read_field_def_ProtocolUnitEject(Other, Z1, Z2).

dg_read_field_def_ProtocolUnitEject(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc)
    when N < 32 - 7 ->
    dg_read_field_def_ProtocolUnitEject(Rest, N + 7,
					X bsl N + Acc);
dg_read_field_def_ProtocolUnitEject(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 -> skip_varint_ProtocolUnitEject(Rest, 0, 0);
      1 -> skip_64_ProtocolUnitEject(Rest, 0, 0);
      2 ->
	  skip_length_delimited_ProtocolUnitEject(Rest, 0, 0);
      5 -> skip_32_ProtocolUnitEject(Rest, 0, 0)
    end;
dg_read_field_def_ProtocolUnitEject(<<>>, 0, 0) ->
    #'ProtocolUnitEject'{}.

skip_varint_ProtocolUnitEject(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2) ->
    skip_varint_ProtocolUnitEject(Rest, Z1, Z2);
skip_varint_ProtocolUnitEject(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2) ->
    dfp_read_field_def_ProtocolUnitEject(Rest, Z1, Z2).


skip_length_delimited_ProtocolUnitEject(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc)
    when N < 57 ->
    skip_length_delimited_ProtocolUnitEject(Rest, N + 7,
					    X bsl N + Acc);
skip_length_delimited_ProtocolUnitEject(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_ProtocolUnitEject(Rest2, 0, 0).


skip_32_ProtocolUnitEject(<<_:32, Rest/binary>>, Z1,
			  Z2) ->
    dfp_read_field_def_ProtocolUnitEject(Rest, Z1, Z2).


skip_64_ProtocolUnitEject(<<_:64, Rest/binary>>, Z1,
			  Z2) ->
    dfp_read_field_def_ProtocolUnitEject(Rest, Z1, Z2).
...
dfp_read_field_def_ProtocolConfig(<<>>, 0, 0, F1) ->
    #'ProtocolConfig'{sync_interval = F1};
dfp_read_field_def_ProtocolConfig(Other, Z1, Z2, F1) ->
    dg_read_field_def_ProtocolConfig(Other, Z1, Z2, F1).
...
dg_read_field_def_ProtocolConfig(<<0:1, X:7,
    ...
    case Key of
      13 ->
	  d_field_ProtocolConfig_sync_interval(Rest, 0, 0, F1);
      _ ->
	  case Key band 7 of
	    0 -> skip_varint_ProtocolConfig(Rest, 0, 0, F1);
	    1 -> skip_64_ProtocolConfig(Rest, 0, 0, F1);
	    2 ->
		skip_length_delimited_ProtocolConfig(Rest, 0, 0, F1);
	    5 -> skip_32_ProtocolConfig(Rest, 0, 0, F1)
	  end
    end;
dg_read_field_def_ProtocolConfig(<<>>, 0, 0, F1) ->
    #'ProtocolConfig'{sync_interval = F1}.
...
skip_varint_ProtocolConfig(<<1:1, _:7, Rest/binary>>,
			   Z1, Z2, F1) ->
    skip_varint_ProtocolConfig(Rest, Z1, Z2, F1);
skip_varint_ProtocolConfig(<<0:1, _:7, Rest/binary>>,
			   Z1, Z2, F1) ->
    dfp_read_field_def_ProtocolConfig(Rest, Z1, Z2, F1).
...
skip_length_delimited_ProtocolConfig(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_ProtocolConfig(Rest2, 0, 0, F1).
...
d_msg_ProtocolUnitSplit(Bin) ->
    dfp_read_field_def_ProtocolUnitSplit(Bin, 0, 0).

dfp_read_field_def_ProtocolUnitSplit(<<>>, 0, 0) ->
    #'ProtocolUnitSplit'{};
dfp_read_field_def_ProtocolUnitSplit(Other, Z1, Z2) ->
    dg_read_field_def_ProtocolUnitSplit(Other, Z1, Z2).

dg_read_field_def_ProtocolUnitSplit(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc)
    when N < 32 - 7 ->
    dg_read_field_def_ProtocolUnitSplit(Rest, N + 7,
					X bsl N + Acc);
dg_read_field_def_ProtocolUnitSplit(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 -> skip_varint_ProtocolUnitSplit(Rest, 0, 0);
      1 -> skip_64_ProtocolUnitSplit(Rest, 0, 0);
      2 ->
	  skip_length_delimited_ProtocolUnitSplit(Rest, 0, 0);
      5 -> skip_32_ProtocolUnitSplit(Rest, 0, 0)
    end;
dg_read_field_def_ProtocolUnitSplit(<<>>, 0, 0) ->
    #'ProtocolUnitSplit'{}.

skip_varint_ProtocolUnitSplit(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2) ->
    skip_varint_ProtocolUnitSplit(Rest, Z1, Z2);
skip_varint_ProtocolUnitSplit(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2) ->
    dfp_read_field_def_ProtocolUnitSplit(Rest, Z1, Z2).


skip_length_delimited_ProtocolUnitSplit(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc)
    when N < 57 ->
    skip_length_delimited_ProtocolUnitSplit(Rest, N + 7,
					    X bsl N + Acc);
skip_length_delimited_ProtocolUnitSplit(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_ProtocolUnitSplit(Rest2, 0, 0).


skip_32_ProtocolUnitSplit(<<_:32, Rest/binary>>, Z1,
			  Z2) ->
    dfp_read_field_def_ProtocolUnitSplit(Rest, Z1, Z2).


skip_64_ProtocolUnitSplit(<<_:64, Rest/binary>>, Z1,
			  Z2) ->
    dfp_read_field_def_ProtocolUnitSplit(Rest, Z1, Z2).
...
merge_msgs(Prev, New)
    ...
    case Prev of
      ...
      #'ProtocolUnitMove.UnitMoving'{} ->
	  'merge_msg_ProtocolUnitMove.UnitMoving'(Prev, New);
      #'ProtocolUnitMove'{} ->
	  merge_msg_ProtocolUnitMove(Prev, New);
      #'ProtocolUnitEject'{} ->
	  merge_msg_ProtocolUnitEject(Prev, New);
      ...
      #'ProtocolUnitSplit'{} ->
	  merge_msg_ProtocolUnitSplit(Prev, New);
      #'ProtocolTimeSync'{} ->
...
'merge_msg_ProtocolUnitMove.UnitMoving'(#'ProtocolUnitMove.UnitMoving'{id
									   =
									   PFid,
								       pos =
									   PFpos,
									   ...
									   =
									   PFdirection},
					#'ProtocolUnitMove.UnitMoving'{id =
									   NFid,
								       pos =
									   NFpos,
								       direction
    ...
    #'ProtocolUnitMove.UnitMoving'{id =
				   ...
				   pos =
				       merge_msg_ProtocolVector2(PFpos, NFpos),
				   direction =
				       merge_msg_ProtocolVector2(PFdirection,
								 NFdirection)}.

merge_msg_ProtocolUnitMove(#'ProtocolUnitMove'{update_at
						   = PFupdate_at,
					       units = PFunits},
			   #'ProtocolUnitMove'{update_at = NFupdate_at,
					       units = NFunits}) ->
    #'ProtocolUnitMove'{update_at =
			    if NFupdate_at =:= undefined -> PFupdate_at;
			       true -> NFupdate_at
			    end,
			units = PFunits ++ NFunits}.

merge_msg_ProtocolUnitEject(_Prev, New) -> New.
...
merge_msg_ProtocolUnitSplit(_Prev, New) -> New.
...
verify_msg(Msg) ->
    case Msg of
      ...
      #'ProtocolUnitMove.UnitMoving'{} ->
	  'v_msg_ProtocolUnitMove.UnitMoving'(Msg,
					      ['ProtocolUnitMove.UnitMoving']);
      #'ProtocolUnitMove'{} ->
	  v_msg_ProtocolUnitMove(Msg, ['ProtocolUnitMove']);
      #'ProtocolUnitEject'{} ->
	  v_msg_ProtocolUnitEject(Msg, ['ProtocolUnitEject']);
      #'ProtocolDot'{} ->
      ...
      #'ProtocolUnitSplit'{} ->
	  v_msg_ProtocolUnitSplit(Msg, ['ProtocolUnitSplit']);
      #'ProtocolTimeSync'{} ->
...
'v_msg_ProtocolUnitMove.UnitMoving'(#'ProtocolUnitMove.UnitMoving'{id
								       = F1,
								   pos = F2,
								   direction =
								       F3},
    ...
    v_msg_ProtocolVector2(F2, [pos | Path]),
    v_msg_ProtocolVector2(F3, [direction | Path]),
    ok;
'v_msg_ProtocolUnitMove.UnitMoving'(X, Path) ->
    mk_type_error({expected_msg,
		   'ProtocolUnitMove.UnitMoving'},
		  X, Path).

v_msg_ProtocolUnitMove(#'ProtocolUnitMove'{update_at =
					       F1,
					   units = F2},
		       Path) ->
    v_type_int64(F1, [update_at | Path]),
    if is_list(F2) ->
	   ['v_msg_ProtocolUnitMove.UnitMoving'(Elem,
						[units | Path])
	    || Elem <- F2];
       true ->
	   mk_type_error({invalid_list_of,
			  {msg, 'ProtocolUnitMove.UnitMoving'}},
			 F2, Path)
    end,
    ok.

v_msg_ProtocolUnitEject(#'ProtocolUnitEject'{},
			_Path) ->
    ok.
...
v_msg_ProtocolConfig(#'ProtocolConfig'{sync_interval =
					   F1},
		     Path) ->
    v_type_float(F1, [sync_interval | Path]), ok.

v_msg_ProtocolUnitSplit(#'ProtocolUnitSplit'{},
			_Path) ->
    ok.
     ...
     {{msg, 'ProtocolUnitMove.UnitMoving'},
      [#field{name = id, fnum = 1, rnum = 2, type = string,
       ...
       #field{name = pos, fnum = 2, rnum = 3,
	      type = {msg, 'ProtocolVector2'}, occurrence = required,
	      opts = []},
       #field{name = direction, fnum = 3, rnum = 4,
	      type = {msg, 'ProtocolVector2'}, occurrence = required,
	      opts = []}]},
     {{msg, 'ProtocolUnitMove'},
      [#field{name = update_at, fnum = 1, rnum = 2,
       ...
       #field{name = units, fnum = 2, rnum = 3,
	      type = {msg, 'ProtocolUnitMove.UnitMoving'},
	      occurrence = repeated, opts = []}]},
     {{msg, 'ProtocolUnitEject'}, []},
     {{msg, 'ProtocolDot'},
      [#field{name = id, fnum = 1, rnum = 2, type = string,
	      occurrence = required, opts = []},
       #field{name = pos, fnum = 2, rnum = 3,
...
get_msg_names() ->
    ['ProtocolVector2', 'ProtocolUnitCreate',
     'ProtocolUnitMove.UnitMoving', 'ProtocolUnitMove',
     'ProtocolUnitEject', 'ProtocolDot', 'ProtocolUnit',
     'ProtocolSceneInit', 'ProtocolUnitAdd',
     'ProtocolSceneSync', 'ProtocolUnitRemove',
     'ProtocolDotRemove', 'ProtocolConfig',
     'ProtocolUnitSplit', 'ProtocolTimeSync'].
...
find_msg_def('ProtocolUnitCreate') ->
    [#field{name = name, fnum = 1, rnum = 2, type = string,
     ...
     #field{name = pos, fnum = 2, rnum = 3,
	    type = {msg, 'ProtocolVector2'}, occurrence = required,
	    opts = []}];
find_msg_def('ProtocolUnitMove.UnitMoving') ->
    [#field{name = id, fnum = 1, rnum = 2, type = string,
	    occurrence = required, opts = []},
     #field{name = pos, fnum = 2, rnum = 3,
	    type = {msg, 'ProtocolVector2'}, occurrence = required,
...
find_msg_def('ProtocolUnitMove') ->
    [#field{name = update_at, fnum = 1, rnum = 2,
     ...
     #field{name = units, fnum = 2, rnum = 3,
	    type = {msg, 'ProtocolUnitMove.UnitMoving'},
	    occurrence = repeated, opts = []}];
find_msg_def('ProtocolUnitEject') -> [];
...
find_msg_def('ProtocolConfig') ->
    [#field{name = sync_interval, fnum = 1, rnum = 2,
	    type = float, occurrence = required, opts = []}];
find_msg_def('ProtocolUnitSplit') -> [];
